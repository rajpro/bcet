    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="panel panel-default panel-table">
          <div class="panel-heading">List of Principal Approvals
          </div>
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <?php if($value->status=='principal_pending'): ?>
                  <td class="actions">
                    <a href="<?=base_url('teacherleave/principal_approve_ok/'.$value->id)?>" class="badge badge-success">Accepted</a>
                  </td>
                  <?php endif; ?>
                </tr>
