    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="panel panel-default panel-border-color panel-border-color-primary">
          <div class="panel-heading panel-heading-divider">Update Teacher<span class="panel-subtitle"></span></div>
          <div class="panel-body">
             <?=form_open_multipart(base_url('teacher/update/'.$model->id))?>
             <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <div class="brn">
                <?=form_dropdown('branch',$branches,$model->branch,['class'=>'form-control input-sm','placeholder'=>'select any one','id'=>'bid'])?>
                </div>
              </div>
             <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                  <label>Registration No.<span style="color:red;">*</span></label>
                   <?=form_input('reg_no',$model->reg_no,['class'=>'form-control input-sm','placeholder'=>'Enter registration no'])?>
              </div>
              <div class="form-group col-md-3">
                <label>Date Of Joining<span style="color:red;">*</span></label>
                 <?=form_input('d_o_joining',$model->d_o_joining,['class'=>'form-control input-sm datepicker','placeholder'=>'Enter Date Of Joining'])?>
              </div>
              <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <?=form_input('qua',$model->qua,['class'=>'form-control input-sm','placeholder'=>'Enter Teacher Qualification '])?>
              </div>
               <div class="form-group col-md-3">
              ...
              <div class="form-group col-md-3">
                ...
                <?=form_input('ph_no',$model->ph_no,['class'=>'form-control input-sm','placeholder'=>'Enter Phone Number '])?>
              </div>
              <div class="form-group col-md-3">
                <label>Change Password</span></label>
